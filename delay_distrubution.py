...
fig.suptitle("Modified PERT Distribution of Task Delays (Actual âˆ’ Estimated)", fontsize=13)
...
ax1.set_xlabel("Delay (Actual âˆ’ Estimated) [time units]")
...
ax2.set_xlabel("Delay (Actual âˆ’ Estimated) [time units]")
...
plt.show()
print("\nPlot saved to delay_distribution.png")
